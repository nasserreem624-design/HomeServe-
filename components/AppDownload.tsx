...
import { Download, ExternalLink, Wrench, Zap, Wind, Sparkles, MapPin, Search } from 'lucide-react';
...
const AppDownload: React.FC = () => {
  ...
  const APP_LINK = "https://homeserve-pro.vercel.app/download"; 
    ...
    <section className="py-24 relative overflow-hidden" id="app-download">
      <div className="container mx-auto px-6">
        <div className="bg-gradient-to-br from-blue-700 to-indigo-900 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl">
          {/* Grid Background Effect - STRICT pointer-events-none */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            <div className="text-right">
              ...
              <div className="flex flex-wrap gap-6 mb-12 justify-end lg:justify-start relative z-20 pointer-events-auto">
                <a 
                  href={PLAY_STORE_URL} 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-white text-slate-900 px-8 py-4 rounded-2xl font-black flex items-center gap-4 hover:scale-105 transition-all shadow-xl group cursor-pointer"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-black flex items-center gap-4 hover:scale-105 transition-all shadow-xl group border border-white/10 cursor-pointer"
                >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-6 p-5 bg-white/10 rounded-3xl border border-white/20 w-fit backdrop-blur-sm group cursor-pointer hover:bg-white/15 transition-all ml-0 mr-auto lg:mr-0 lg:ml-auto relative z-20 pointer-events-auto"
              >
            ...
            <div className="relative flex justify-center lg:justify-end mt-12 lg:mt-0 z-10">
              ...
              {/* Floating Elements - STRICT pointer-events-none */}
              <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-orange-500 rounded-full blur-[100px] opacity-30 pointer-events-none z-0"></div>
              <div className="absolute top-1/2 -left-12 w-24 h-24 bg-blue-400 rounded-full blur-[60px] opacity-20 pointer-events-none z-0"></div>
            </div>
          </div>
        </div>
      </div>
